...
/* main: Call read_cards, analyze_hand, and print_result repeatedly */
int main (void)
{
    for (;;)
    {
...
/* analyze_hand: Determines whether the hand contains a straights, a flush, four-of-a-kind, and/or three-of-a-kind; determines the number of pairs; stores the results into the external varialbes straight, flush, four, three and pairs. */
void analyze_hand (void)
{
    int num_consec = 0;
    int rank, suit;
