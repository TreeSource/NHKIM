...
/* initialize_number_generator: initializes the random number using the time of the day */
void initialize_number_generator (void)
{
    srand((unsigned) time (NULL));
}

/* new_secret_number: Returns a randomly choosen number between 1 and MAX_NUMBER */
void new_secret_number (void) { return rand() % MAX_NUMBER; }
...
void read_guesses (int secretnumber)
{
